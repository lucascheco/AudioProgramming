...
//==============================================================================
DistortionPlugInCAudioProcessorEditor::DistortionPlugInCAudioProcessorEditor (DistortionPlugInCAudioProcessor& p)
...
DistortionPlugInCAudioProcessorEditor::~DistortionPlugInCAudioProcessorEditor()
{
}

//==============================================================================
void DistortionPlugInCAudioProcessorEditor::paint (Graphics& g)
{
   ...
   // g.drawFittedText ("Hello World!", getLocalBounds(), Justification::centred, 1);
	...
	g.drawText("Drive", ((getWidth() / 5) * 1) - (100 / 2), (getHeight() / 2) - (100 / 2) + 5, 100, 100, Justification::centred, false);
	g.drawText("Range", ((getWidth() / 5) * 2) - (100 / 2), (getHeight() / 2) - (100 / 2) + 5, 100, 100, Justification::centred, false);
	g.drawText("Mix", ((getWidth() / 5) * 3) - (100 / 2), (getHeight() / 2) - (100 / 2) + 5, 100, 100, Justification::centred, false);
	g.drawText("Volume", ((getWidth() / 5) * 4) - (100 / 2), (getHeight() / 2) - (100 / 2) + 5, 100, 100, Justification::centred, false);
}

void DistortionPlugInCAudioProcessorEditor::resized()
{
